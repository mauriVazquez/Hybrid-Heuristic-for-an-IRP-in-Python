...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Cliente',
            fields=[
                ('entidad_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='entidades.entidad')),
                ('nivel_demanda', models.IntegerField(help_text='Nivel de demanda')),
            ],
            options={
                'verbose_name_plural': 'Clientes',
            },
            bases=('entidades.entidad',),
        ),
        migrations.CreateModel(
            name='Proveedor',
            fields=[
