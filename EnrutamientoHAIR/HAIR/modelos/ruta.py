...
class Ruta():
    ...
    - to_json(): Reduce la cantidad entregada a un cliente específico.
    """
    ...
    def obtener_costo_recorrido(clientes) -> float:
        ...
        return 0 if not clientes else (
            ...
            constantes.compute_distancia_proveedor(clientes[0].coord_x, clientes[0].coord_y) + constantes.compute_distancia_proveedor(clientes[-1].coord_x, clientes[-1].coord_y) +
    ...
    def __str__(self) -> str:
        ...
        """
        clientes_ids = [i for i, cliente in enumerate(self.clientes)]
