...
class Graph():
    def draw_routes(coords,routes, supplier_coords):
        enum_clients = ['red','green','blue','purple','orange','yellow','cyan','magenta','pink','brown','black','white','gray','darkgray']
        ...
        for index, coord in enumerate(coords):
            # Graficar los puntos
            plt.scatter(coord[0], coord[1], color=enum_clients[index], marker=('^' if index ==0 else 'o'), label=('Provider' if index ==0 else 'Client'+str(index)),zorder=2)
