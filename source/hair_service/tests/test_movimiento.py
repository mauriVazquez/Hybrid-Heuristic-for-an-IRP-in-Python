...
class TestVariantesSolucion(unittest.TestCase):
    ...
    def test_variante_eliminacion(self):
        ...
        soluciones_esperadas = [
            ...
            "[[],[]],[[3],[116]],[[4,2,1],[72,105,95]]",     # Eliminar 5 en T2
            "[[],[]],[[5],[22]],[[4,2,1],[72,105,95]]",     # Eliminar 3 en T2
            "[[],[]],[[5,3],[22,116]],[[2,1],[105,95]]",     # Eliminar 4 en T3
            "[[],[]],[[5,3],[22,116]],[[4,1],[72,95]]",     # Eliminar 2 en T3
            "[[],[]],[[5,3],[22,116]],[[4,2],[72,105]]",     # Eliminar 1 en T3
        ]
        for sol in vecindario:
            comparable = ",".join(str(ruta).replace(" ", "") for ruta in sol.rutas)
        ...
        soluciones_esperadas = [   
            ...
            "[[4,5],[24,18]],[[1,2],[130,70]],[[4,1],[72,130]]",    # Eliminar 3 en T1
            "[[3,5],[116,18]],[[1,2],[130,70]],[[4,1],[72,130]]",   # Eliminar 4 en T1
            "[[3,4],[116,24]],[[1,2],[130,70]],[[4,1],[72,130]]",   # Eliminar 5 en T1
            "[[3,4,5],[116,24,18]],[[2],[70]],[[4,1],[72,130]]",    # Eliminar 1 en T2
            "[[3,4,5],[116,24,18]],[[1],[130]],[[4,1],[72,130]]",   # Eliminar 2 en T1 
            "[[3,4,5],[116,24,18]],[[1,2],[130,70]],[[4],[72]]",    # Eliminar 1 en T3
            "[[3,4,5],[116,24,18]],[[1,2],[130,70]],[[1],[130]]",   # Eliminar 4 en T1
        ]
        for sol in vecindario:
            comparable = ",".join(str(ruta).replace(" ", "") for ruta in sol.rutas)
            self.assertIn(comparable, soluciones_esperadas, f"La solución {comparable} no está en las soluciones esperadas.")
