...
class SolucionesUtils():
    ...
    @staticmethod 
    def variante_eliminacion(solucion) -> list[Type["Solucion"]]:
        neighborhood_prima = []
        for cliente in constantes.clientes:
    ...
    @staticmethod
    def variante_insercion(solucion) -> list[Type["Solucion"]]:
        neighborhood_prima = []
        for cliente in constantes.clientes:
            for tiempo in range(constantes.horizon_length):
                solucion_copy = solucion.clonar()
    ...
    @staticmethod
    def variante_mover_visita(solucion) -> list[Type["Solucion"]]:
        neighborhood_prima = []
        for cliente in constantes.clientes:
    ...
    @staticmethod
    def variante_intercambiar_visitas(solucion) -> list[Type["Solucion"]]:
        neighborhood_prima = []
    ...
    def mover(solucion) -> Type["Solucion"]:
        neighborhood = SolucionesUtils.variante_eliminacion(solucion)
        neighborhood += SolucionesUtils.variante_insercion(solucion)
        neighborhood += SolucionesUtils.variante_mover_visita(solucion)
        neighborhood += SolucionesUtils.variante_intercambiar_visitas(solucion)
